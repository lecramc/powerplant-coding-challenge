...
def test_production_plan_usecase() -> None:
    ...
    plants = [
        PowerPlantFactory.create_gas_fired(name="gasplant1", efficiency=0.5, pmin=100, pmax=300),
        PowerPlantFactory.create_turbojet(name="turbojet1", efficiency=0.3, pmin=0, pmax=200),
